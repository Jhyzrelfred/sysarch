...
public class CampspotDTO {
    ...
    public CampspotDTO(String aCampName, String bLocation, String cAmenities, String dActivities, String eAccomodation, String fAccessibilities, String gNetwork, String hTransportation) {
